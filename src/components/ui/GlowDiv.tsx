...
interface GlowDivProps extends React.HTMLAttributes<HTMLDivElement> {
  children: React.ReactNode
  variant?: "blue" | "purple" | "green" | "orange" | "pink" | "cyan" | "rainbow" | "red" | "white"
  size?: "sm" | "md" | "lg"
}

export function GlowDiv({ children, className, variant = "blue", size = "md", ...props }: GlowDivProps) {
  const variants = {
    ...
    white: "bg-white border-gray-300/30 text-black shadow-[0_0_12px_rgba(255,255,255,0.35),0_0_24px_rgba(255,255,255,0.18)] hover:shadow-[0_0_16px_rgba(255,255,255,0.48),0_0_32px_rgba(255,255,255,0.24)]",
  }
